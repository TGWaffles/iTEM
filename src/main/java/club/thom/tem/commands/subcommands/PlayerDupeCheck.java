...
public class PlayerDupeCheck implements SubCommand {
    ...
    public void execute(ICommandSender sender, String[] args) {
        ...
        EssentialAPI.getNotifications().push(username + " Dupe Check", "Downloading inventory...", 1.0f);
        try {
        ...
        EssentialAPI.getNotifications().push(username + " Dupe Check", "Inventory Downloaded!", 1.0f);
